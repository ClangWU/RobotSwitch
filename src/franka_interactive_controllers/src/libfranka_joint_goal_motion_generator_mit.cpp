    ...
    switch(goal_id) {
       ...
       case 3  :
        std::cout << "Selected q_grasping_top as goal" << std::endl;
          ...
          q_goal = {{-0.59783268139441, 0.2492733557273072, -0.005049417577373607, -1.3849726974588163, -0.00840939170535976, 1.6412078496201297, 0.22738222793650276}};
          break;
       ...
       case 4  :
        std::cout << "Selected q_grasping_bottom as goal" << std::endl;
          ...
          q_goal = {{-0.6878626855779112, -0.04851089525172141, -0.026444763331351206, -1.7673592103155036, -0.0068880141125223, 1.7328725777628458, 0.1250351602103975}};
          break;
       ...
       case 5  :
        std::cout << "Selected q_inspection_start as goal" << std::endl;
          ...
          q_goal = {{-0.3056538587641297, -0.1913451224732268, 0.07008958757101831, -1.879797846025211, 0.015819555071036124, 1.6602105629768678, 0.5954499479416334}};
          break;
       ...
       case 6  :
        ...
        q_goal = {{0.923916151753756, 0.39529699280805747, -0.2719142573211088, -1.0662516640428945, 0.11596471634838317, 1.4617931707700094, 1.5076317753370667}};
          break;
