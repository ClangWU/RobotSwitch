  ...
  try {
    ...
    switch(goal_id) {
       ...
       case 3  :
          ...
          q_goal = {{-0.03855593675653259, 0.21116865287677583, 0.03702338206402042, -2.364238997889118, -0.014322265182705756, 2.5745495350600174, 0.795705754840742}};
          break;

       case 4  :
        std::cout << "Selected q_release as goal" << std::endl;
          q_goal = {{0.05532625134737919, 0.4956275373341744, 0.03496940450187315, -2.3175547607488793, -0.05061304349121119, 2.8106076896984065, 0.919742240097297}};
          break;
       // case 4  :
