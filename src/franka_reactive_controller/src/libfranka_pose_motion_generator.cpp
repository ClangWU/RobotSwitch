...
#include <franka_utils/examples_common.h>
...
// new_pose[2] = 0.0;  new_pose[6] = 0.0;  new_pose[10] = 1.0; new_pose[14] += delta_z;
// new_pose[3] = 0;    new_pose[7] = 0;    new_pose[11] =0;    new_pose[15] = 1;
