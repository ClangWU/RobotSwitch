...
#include <franka_reactive_controller/cartesian_velocity_node_controller.h>
...
PLUGINLIB_EXPORT_CLASS(franka_reactive_controller::CartesianVelocityNodeController,
